    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        editButton.setOnAction(event -> {
            try {
                ...
                log.error("Salary Edit Failed " + e.getMessage());
...
//        searchTypeText.setOnAction(event -> {
//            searchByIdAndType();
//        });
//        searchIdText.setOnAction(event -> {
//            searchByIdAndType();
//        });
    ...
    public void selectFromTable() {
        try {
            ...
            personIdText.setText(String.valueOf(salary.getPerson()));
